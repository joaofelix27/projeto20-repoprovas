...
const createTest = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield testsService.createTest(testData);
    if (result) {
...
const getTestByDisciplines = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield testsService.getTestByDisciplines();
    if (result) {
...
const getTestByTeachers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield testsService.getTestByTeachers();
    if (result) {
        return res.status(200).send(result);
    }
    else {
