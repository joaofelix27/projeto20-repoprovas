...
describe('GET /tests/teachers', () => {
    it('Expected to return 401 when not sending an authorization', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield agent.get('/tests/teachers');
        expect(result.status).toBe(401);
    }));
    it('Expected to return 401 when not sending a valid token', () => __awaiter(void 0, void 0, void 0, function* () {
        const token = '';
        const result = yield agent.get('/tests/teachers').set({ Authorization: `Bearer ${token}` });
        expect(result.status).toBe(401);
    }));
    it('Expected to return 200 when the token is valid and the test by teachers is returned', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield agent.get('/tests/teachers').set({ Authorization: `Bearer ${resultLogin.text}` });
